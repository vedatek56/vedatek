...
export default function PartnerMarquee() {
  // 4 identical sets (28 items total) mapped with uniform gap. Moving -25% translates exactly 1 full set (7 items)
  const scrollItems = [...partners, ...partners, ...partners, ...partners];

  return (
    <div className="w-full py-5 sm:py-7 bg-slate-900 border-y border-slate-800 overflow-hidden relative select-none">
      ...
      <div className="flex items-center overflow-hidden">
        <div className="flex shrink-0 gap-6 sm:gap-10 md:gap-16 animate-marquee whitespace-nowrap will-change-transform">
